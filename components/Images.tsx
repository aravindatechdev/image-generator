...
function Images() {
    ...
    return (
        <div>
            <button onClick={() => refreshImages(images)} className='fixed bottom-10 right-10 bg-violet-400/90 text-white px-5 py-3 rounded-md hover:bg-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-400 font-bold z-20'>
                {
            ...
            {
                isLoading && (
                    <p className='animate-pulse text-center pb-7 font-extralight'>Loading<span className='text-violet-400'>AI</span>Generated Images</p>
                )
            }
