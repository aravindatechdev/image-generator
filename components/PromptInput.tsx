    ...
    return (
        <div className="m-10">
            <form className="flex flex-col lg:flex-row shadow-md shadow-slate-400/10 border rounded-md lg:divide-x">
                <textarea className="flex-1 p-4 outline-none rounded-md" placeholder="Enter a Prompt" value={input} onChange={(e) => setInput(e.target.value)} />
                ...
                <button type="button" name="suggestion" className="p-4 bg-white text-violet-500 border-none transition-colors duration-200 rounded-b-md md:rounded-r-md md:rounded-bl-none font-bold">New Suggestion</button>
